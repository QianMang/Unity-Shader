//bass pass and add pass 
//so this shader can handle multiple light.
//also receive shadow

Shader "Unlit/lForwardRendering"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			fixed4 frag(v2f i) : SV_Target
			{
				...
				fixed3 diffuse = _LightColor0 * _Diffuse.rgb * saturate(dot(i.worldNormal,worldLightDir));
				//specular
